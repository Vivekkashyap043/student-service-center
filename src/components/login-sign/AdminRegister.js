  ...
  return (
    <div className="back" >
      ...
      <form
        ...
        onSubmit={handleSubmit(onAdminRegister)}
      >
              ...
              <div className="row">
                <div className="col">
                  <div className="mb-3">
                    ...
                    <input type="text" id="eid" className="form-control" {...register("eid", { required: true, })} />
                ...
                <div className="col">
                  <div className="mb-3">
                    ...
                    <input type="text" id="fname" className="form-control" {...register("name", { required: true})} />
        ...
        <div className="row p-3">
                <p>Already register? <Link to="/login/admin-login">Login</Link></p>
          </div>
      </form>
          </div>
        </div>
